...
```{r combined-basemap-network-graph}
...
```{r solo-network-visualization)}
plot(vis_1 + labs(title = "NYC Network Visualization"))
#ggsave(filename = here("final_outputs/3_1_Network_map.png"), plot = vis_1 + labs(title = "NYC Network Visualization"), dpi = 600)
```
